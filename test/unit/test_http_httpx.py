...
pytest.importorskip("ipfshttpclient4ipwb.http_httpx")
import ipfshttpclient4ipwb.http_httpx
...
def test_map_args_to_httpx(kwargs, expected):
	assert ipfshttpclient4ipwb.http_httpx.map_args_to_httpx(**kwargs) == expected
...
def test_client_args_to_session_kwargs(args, kwargs, expected_kwargs, expected_base, expected_laddr):
	client = ipfshttpclient4ipwb.http_httpx.ClientSync(*args, **kwargs)
