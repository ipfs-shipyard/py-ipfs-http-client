...
pytest.importorskip("ipfshttpclient4ipwb.http_requests")
import ipfshttpclient4ipwb.http_requests
...
def test_map_args_to_requests(kwargs, expected):
	assert ipfshttpclient4ipwb.http_requests.map_args_to_requests(**kwargs) == expected
...
def test_client_args_to_session_props(args, kwargs, expected1, expected2, expected3):
	client = ipfshttpclient4ipwb.http_requests.ClientSync(*args, **kwargs)
