...
# -*- coding: utf-8 -*-
#
# Python IPFS API documentation build configuration file, created by
...
with open(os.path.join(sys.path[0], 'ipfsapi', 'version.py')) as file:
    exec(file.read())
...
project = 'Python IPFS API'
copyright = '2016, py-ipfs-api team'
...
#html_title = 'Python IPFS API v0.2.4'
...
latex_documents = [
    (master_doc, 'PythonIPFSAPI.tex', 'Python IPFS API Documentation',
     'py-ipfs-api team', 'manual'),
]
...
man_pages = [
    (master_doc, 'py-ipfs-api', 'Python IPFS API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py-ipfs-api', 'Python IPFS API Documentation',
     author, 'py-ipfs-api', 'One line description of project.',
     'Miscellaneous'),
]
