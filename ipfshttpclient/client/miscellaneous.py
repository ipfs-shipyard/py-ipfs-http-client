...
class Base(base.ClientBase):
    ...
    def dns(self, domain_name: str, recursive: bool = False, **kwargs: base.CommonArgs):
    ...
    def ping(self, peer: str, *peers: str, count: int = 10, **kwargs: base.CommonArgs):
    ...
    @base.returns_single_item(base.ResponseBase)
    def resolve(self, path: str, recursive: bool = False, **kwargs: base.CommonArgs):
